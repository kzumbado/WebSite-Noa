...
function HomePage() {
  ...
  return (
    <div>
        ...
        <div className={`hero w-full bg-background dark:bg-backgroundNight px-6 md:px-16 py-20 md:py-40 xl:px-40 3xl:px-60 flex flex-col lg:flex-row lg:items-center lg:justify-evenly`}>
