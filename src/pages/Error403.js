  ...
  return (
    ...
    <div className="grid h-screen place-content-center bg-white dark:bg-backgroundNight">
      <div className="text-center max-w-sm">
        <strong className="text-9xl font-black text-gray-300">403</strong>

        <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-400 sm:text-4xl">
          Uh-oh!
        </h1>

        <p className="mt-4 text-gray-500 dark:text-background">{t("403.message")}</p>
